...
from problems.dtsppl.state_dtsppl import StateDTSPPL
...
class DTSPPL(object):
    ...
    def get_costs(dataset, pi):
        ...
        assert DTSPPL._is_valid(pi), "Invalid solution"
        
    
    @staticmethod
    def make_dataset(*args, **kwargs):
        return DTSPPLDataset(*args, **kwargs)

    @staticmethod
    def make_state(*args, **kwargs):
        return StateDTSPPL.initialize(*args, **kwargs)
